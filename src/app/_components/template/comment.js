  ...
  return (
    <div className="w-full bg-black/5 dark:bg-black/10 flex flex-col p-4 gap-1 rounded-lg overflow-hidden">
      <div className="w-full flex items-center gap-8">
        ...
        />
        <p className="w-full text-[1.2rem] sm:text-[1.4rem] text-bold border-b-1 border-black/20 dark:border-first/50 font-light sm:font-medium">استاد ممنون بابت تدریستان</p>
      </div>
