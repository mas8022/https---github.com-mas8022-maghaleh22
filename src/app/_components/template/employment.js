    ...
    <div className="w-full flex gap-10">
      <div className="w-1/2 flex flex-col gap-12">
        <p className="describe w-full p-8 text-[1.4rem] font-light dark:bg-[#0f172a] leading-[27px] dark:text-first text-justify shadow-md dark:shadow-2xl rounded-3xl">
          ...
          پس از قبول شرایط، فرم ثبت‌نام را پر کنید. همچنین لازم است یک عکس واضح
          از خودتان ارسال کنید که در آن کارت ملی خود را در دست راست و متنی از{" "}
          <Link
            href={"/employmentRule"}
        ...
        <form
          className="w-full flex flex-col gap-7 p-[2rem] sm:p-[3rem] md:sm:p-[5rem]  py-[4rem] items-center bg-second/30 dark:bg-black/30 dark:shadow-2xl rounded-3xl child:h-16 child:outline-none child:focus:outline-none"
